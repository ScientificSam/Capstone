...
select  gl.playdate, gl.`number`, gl.`day`, gl.vteam, gl.hteam, gl.vscore, gl.hscore, gl.hleague, gl.len_game, gl.daynight, gl.park_id, gl.attendance, 
		...
		gl.player_ages, gl.player_exps, pb.player_weights, pb.player_heights, pb.player_throws, pb.player_bats, gl.v_win_val
		from capstone.gamelogs gl, capstone.player_bio pb 
		where gl.v_win_val is not null
			  and gl.id = pb.id